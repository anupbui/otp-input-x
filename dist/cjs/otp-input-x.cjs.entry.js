...
const OtpInputX = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("div", { class: "otp-box" }, this.getOTP().map((val, index$1) => index.h("input", { id: 'otp20x' + index$1, size: 1, type: this.format, value: val, class: this.styleName })))));
    }
