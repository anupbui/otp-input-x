...
const OtpInputX = class extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        attachShadow(this);
    ...
    static get style() { return otpInputXCss; }
};

const OtpInputX$1 = /*@__PURE__*/proxyCustomElement(OtpInputX, [1,"otp-input-x",{"size":[2],"format":[1],"otp":[1025],"styleName":[1,"style-name"]}]);
...
export { OtpInputX$1 as OtpInputX, defineCustomElements };
